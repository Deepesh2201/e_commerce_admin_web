    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <form method="POST" action="{{ route('purchase.code',['token'=>bcrypt('step_3')]) }}">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="purchase_key" class="form-control" name="purchase_key"
                                           placeholder="{{ translate('Ex: 19xxxxxx-ca5c-49c2-83f6-696a738b0000') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="{{ route('step3',['token'=>bcrypt('step_3')]) }}"><button type="button" class="btn btn-dark px-sm-5">{{ translate('Continue') }}</button></a>    
                </div>
            </form>
        </div>
    </div>
